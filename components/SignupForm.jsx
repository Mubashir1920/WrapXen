...
const SignupForm = () => {
    return (
        ...
        <div class="flex  h-[calc(100vh-80px)] items-center justify-center">
            <div class="relative flex flex-col rounded-xl border border-gray-200 p-5 bg-transparent bg-clip-border text-gray-700 shadow-none">
                <h4 class="text-2xl text-center uppercase text-black tracking-tight font-extrabold">
                    Sign Up
                </h4>
                <form class="mt-8 mb-2 w-80 max-w-screen-lg sm:w-96">
                    ...
                    <div class="inline-flex items-center">
                        ...
                        >
                            <input
                                type="checkbox"
                                class="before:content[''] peer relative h-5 w-5 cursor-pointer appearance-none rounded-md border border-blue-gray-200 transition-all before:absolute before:top-2/4 before:left-2/4 before:block before:h-12 before:w-12 before:-translate-y-2/4 before:-translate-x-2/4 before:rounded-full before:bg-blue-gray-500 before:opacity-0 before:transition-opacity checked:border-gray-900 checked:bg-black checked:before:bg-gray-900 hover:before:opacity-10"
                                id="checkbox"
                            />
                        ...
                        >
                            <p class="flex items-center font-sans text-sm font-normal leading-normal text-gray-700 antialiased">
                                I agree the
                                <a
                                    class="font-semibold transition-colors hover:text-black"
                                    href="#"
                                >
                    ...
                    <button
                        class="mt-6 block w-full select-none rounded-lg bg-black py-3 px-6 text-center align-middle font-sans text-xs font-bold uppercase text-white shadow-md  transition-all hover:shadow-lg  focus:opacity-[0.85] focus:shadow-none active:opacity-[0.85] active:shadow-none disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none"
                        type="button"
                    ...
                    <p class="mt-4 block text-center font-sans text-base font-normal leading-relaxed text-gray-700 antialiased">
                        ...
                        <Link
                            class="font-semibold text-black transition-colors hover:text-blue-700"
                            href="/login"
                        >
                            {' '}Login
                        </Link>
