...
const SignupForm = () => {
    ...
    return (
        ...
        <div className="flex  mb-20 mt-32 items-center justify-center">
            <div className="relative flex flex-col rounded-xl border border-gray-200 p-5 bg-transparent bg-clip-border text-gray-700 shadow-none">
                <h4 className="text-2xl text-center uppercase text-black tracking-tight font-extrabold">
                    Sign Up
                </h4>
                <form onSubmit={handleSubmitChange} className="mt-8 mb-2 w-80 max-w-screen-lg sm:w-96">
                    ...
                    >
                        {loading ? (<AiOutlineLoading size={22} className='animate-spin ' />) : ('Register')}

                    </button>
                    <p className="mt-4 block text-center text-sm    text-gray-700 ">
                        Already have an account?
                        <Link
                            className="font-semibold text-black transition-colors hover:text-blue-700"
                            href="/login"
                        >
                            {' '}Login
                        </Link>
