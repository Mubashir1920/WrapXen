    ...
    return (
        <div className="container mx-auto py-16 px-2" >
            ...
            <div className="flex justify-start md:justify-center items-center">
                ...
                <h2 className="md:text-3xl text-2xl font-bold md:font-medium md:text-center text-gray-800 italic capitalize mx-2" >Our Best Sellers</h2>
                <hr className="hidden md:block w-[35%] bg-black h-0.5" />
            </div>
            <p className="md:text-center text-left  px-2  text-gray-700 italic text-sm font-normal capitalize " > laptop skins that offer a perfect mix of style and protection for your device.</p>
            <div className="grid justify-items-center grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4  py-12">
